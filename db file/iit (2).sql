...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 30, 2023 at 11:50 AM
...
(6, 1, 'Advanced Certification in Data Science and AI', 'Learn Data Science and AI from IIT Faculty with Campus Immersion @ IIT Roorkee', '1701101544.png', 1, '120,000', 'Parakash Raina', '200', '188', '122', '5.00 pm - 7.00 pm', 1, 'Gain expertise in Machine Learning and Artificial Intelligence through an advanced certification program in Data Science and AI offered by iHUB DivyaSampark, a Technology Innovation Hub of IIT Roorkee, in collaboration with Intellipaat. Benefit from learning directly from IIT Faculty and industry experts, with personalized 1:1 mentorship, in this immersive online bootcamp.', 1, '1697451115.pdf', '4.5', 1, 2, NULL, '2023-10-16 04:02:12', '2023-11-27 11:12:25'),
...
(82, '2023_11_29_062529_create_updates_table', 31),
(83, '2023_11_30_094509_create_user_permissions_table', 32);
...
CREATE TABLE `updates` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `token` varchar(255) NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0: not sent, 1: sent, 2: failed',
...
INSERT INTO `updates` (`id`, `token`, `status`, `action`, `created_at`, `updated_at`) VALUES
(2, '3f721af1d2e1eab46df7f120a7e7b44e', 1, 'none', '2023-11-29 02:48:43', '2023-11-29 02:48:43');
...
(2, 'Arjun Mehta', 'IT & Ops', '1695643194.jpg', '1', 'admin@ihub.com', '2023-09-05 07:56:45', 1, '$2y$10$uWiEUHBfajfIzGiDgdp33OAiDU7sOIo2l.aZwD720uphNjBirc0t6', NULL, '2023-09-05 07:56:23', '2023-11-30 05:42:21', '2023-11-30 05:42:21'),
(12, 'Rohit Sharma', 'Leads Generation Team', '1701340996.jpg', '0', 'calebjanaltair@gmail.com', '2023-11-30 05:36:34', 1, '$2y$10$.tZniuaF1DP2L4XoeMIMq.VJDU.1y53fPaCf.Twx2O0YTDPLjxDKO', NULL, '2023-11-30 05:36:34', '2023-11-30 05:48:20', '2023-11-30 05:48:20');
...
CREATE TABLE `user_permissions` (
  ...
  `MainModule` tinyint(1) NOT NULL DEFAULT 0,
  `TrainingModule` tinyint(1) NOT NULL DEFAULT 0,
  `StartupsModule` tinyint(1) NOT NULL DEFAULT 0,
  `blogModule` tinyint(1) NOT NULL DEFAULT 0,
  `fellowshipModule` tinyint(1) NOT NULL DEFAULT 0,
  `ConsultancyModule` tinyint(1) NOT NULL DEFAULT 0,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_permissions` (`id`, `user_id`, `MainModule`, `TrainingModule`, `StartupsModule`, `blogModule`, `fellowshipModule`, `ConsultancyModule`, `created_at`, `updated_at`) VALUES
(2, 2, 1, 1, 1, 1, 1, 1, '2023-09-05 09:52:43', NULL),
(9, 12, 0, 0, 1, 1, 0, 0, '2023-11-30 05:36:34', '2023-11-30 05:49:21');
