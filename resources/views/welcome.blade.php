    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 my-1">
                <div class="about">
                    <p>The Indian Government's Department of Science and Technology is executing the National Mission on Interdisciplinary Cyber-Physical Systems (NM-ICPS), approved by the Union Cabinet in December 2018. As part of the mission, iHUB DivyaSampark at IIT Roorkee, focused on technology development, human resources, technology incubation, startups, and international collaborative research.</p>
                    ...
                    <div class="health">
                        <ul class="d-flex justify-content-between">
                            <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
                                ...
                                </svg><b>Healthcare</b></li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">

                                    <path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z" />
                                </svg><b>Industry 4.0</b></li>
                            <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">

                                    <path d="M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM369 209c9.4-9.4 9.4-24.6 0-33.9s-24.6-9.4-33.9 0l-111 111-47-47c-9.4-9.4-24.6-9.4-33.9 0s-9.4 24.6 0 33.9l64 64c9.4 9.4 24.6 9.4 33.9 0L369 209z" />
                                </svg><b>Smart Cities</b></li>
                                <li><svg xmlns="http://www.w3.org/2000/svg" height="2em" viewBox="0 0 512 512">
