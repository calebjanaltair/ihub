...
<body>
    <section class="container">
        ...
        <div class="email-content container">
            <p>Meanwhile Visit Our Homepage for More Information</p>
            <!-- <div class="input-box "> aling button inside this di in center -->
            <div class="input-box text-center container" >
