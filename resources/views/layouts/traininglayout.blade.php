    ...
    <footer id="footer">
        ...
        <div class="container d-md-flex py-4">
            ...
            <div class="social-links text-center text-md-right pt-3 pt-md-0">
                <a href="https://x.com/divyasampark?s=20" target="_blank" class="twitter"><i class="bx bxl-twitter"></i></a>
                <a href="https://www.facebook.com/Divyasampark?mibextid=eHce3h" target="_blank" class="facebook"><i class="bx bxl-facebook"></i></a>
                <a href="https://www.instagram.com/divyasampark_tih_iitr?igshid=OGQ5ZDc2ODk2ZA==" target="_blank" class="instagram"><i class="bx bxl-instagram"></i></a>
                <a href=https://youtube.com/@ihubdivyasampark?si=VVsWkEMnFEYYbfF9"" target="_blank" class="google-plus"><i class="bx bxl-youtube"></i></a>
                <a href="https://www.linkedin.com/company/divyasampark-ihub-roorkee-for-devices-materials-and-technology-foundation/mycompany/" target="_blank" class="linkedin"><i class="bx bxl-linkedin"></i></a>
            </div>
        </div>
    </footer><!-- End Footer -->
