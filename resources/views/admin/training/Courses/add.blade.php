    ...
    <div class="col-lg-12">
        ...
        <div class="ibox">
            ...
            <div class="ibox-content">
                <form action="{{ route('course-management-store') }}" method="post" id="addRecord" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col my-auto">
                            <img id="Demoimage" src="/assets/img/cover.png" style="width: 550px; height: auto;" alt="Croppable Image">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="trainer" id="trainer" required />
                        </div>
                        <div class="col">
                            <label class="form-label">
                                <h4>Course Total Seats</h4>
                            </label>
                            <input type="text" class="form-control" name="seats" id="seats" required>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <div class="col">
                    ...
                    <div class="row mb-3">
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="favourites" id="favourites" required>
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" name="enrolled" id="enrolled" required>
