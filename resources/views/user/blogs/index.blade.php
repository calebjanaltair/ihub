...
<body>
    ...
    <div class="container py-5">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img class="card-img-top" src="./public/uploads/blog/{{$blog->image}}" width="100%" height="auto" alt="Card image cap">
                    <div class="card-body">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="col-6 mx-auto my-auto">
                            <img src="./public/uploads/blog/{{$blog->image}}" width="600px" height="auto" alt="">
                        </div>
