...
<body>
    ...
    <div class="container">
        <div class="headingss pt-4">
            ...
            <p>Fellowship Programs</p>
        </div>
        <div class="startup">
            <p>We at iHUB DivyaSampark are here to develop highly knowledgeable human resources with top-order skills and we strongly believe that young innovative minds have huge potential to transform the world. To ignite student’s innovation and entrepreneurship potential,we are offering Comprehensive and Holistic Advancement of National Knowledge Yield and Analytics (CHANAKYA) fellowships to motivated students who want to work in the broad area of smart devices and materials for cyber physical systems.</p>
            <p>
                We invite you to come up with an original idea that creates new CPS technology and solve real world Problems.
            </p>
        </div>
    </div>
    ...
    <div class="container">
        <div class="headingss pt-4">
            <h2>Our Fellowship Programs</h2>
        </div>
        <div class="row">
            @foreach($fellowships as $fellowship)
            <div class="col-lg-6 my-2">

                <div class="card border-0 event-click-card p-2" data-bs-toggle="modal" data-bs-target="#exampleModal{{$fellowship->id}}">
                    <div class="row">
                        <div class="col-3">
                            <img src="{{asset('/public/uploads/fellowships/poster/' . $fellowship->image)}}" width="100%" height="auto" alt="">
                        </div>
                        <div class="col-8 p-0">
                            <div class="event-click">
                                <h3>{{$fellowship->name}}</h3>
                                <p><strong>{{ substr(strip_tags(htmlspecialchars_decode($fellowship->description)), 0, 20) }}</strong>{{ substr(strip_tags(htmlspecialchars_decode($fellowship->description)), 20, 200) }} ... <i>Read More</i></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="modal fade" id="exampleModal{{$fellowship->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-body">
                            <div class="row">
                                <h5 class="modal-title" id="exampleModalLabel">{{$fellowship->name}}</h5>
                            </div>
                            <div class="row">
                        ...
                        <div class="modal-footer">
                            <button data-bs-toggle="modal" class="btn btn-primary btn-sm" id="download_button" data-id="{{$fellowship->id}}" onclick="addID('{{$fellowship->id}}')" data-bs-target="#downloadModal">Download Brochure</button>
                            <button class="btn btn-primary btn-sm" onclick="openLink('{{$fellowship->link}}')">Apply Now</button>
    ...
    <div class="modal fade" id="downloadModal" tabindex="-1" aria-labelledby="downloadModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="modalform" id="downloadForm" method="post" action="{{route('download-fellowship-brochure')}}">
                        @csrf
