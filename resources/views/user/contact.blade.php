...
<div class="bgheroo mt-5 h-100">
    ...
    <div class="container pt-4">
        ...
        <div class="hiringlinks">
            <ol>
                ...
                <li>
                    <a href="{{$recruitment->link}}">{{$recruitment->name}}
                    </a>
                </li>
                @endforeach
    ...
    <div class="container">
        ...
        <div class="col-lg-12">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d6920.035564900607!2d77.895736!3d29.863761!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x390eb36f96b33845%3A0x1709b6346fdbd60b!2sE%26C%20Dept%2C%20IIT%20Roorkee!5e0!3m2!1sen!2sin!4v1693000564257!5m2!1sen!2sin" width="100%" height="400" style="border: 0" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade" class="py-3"></iframe>
        </div>
            ...
            <div class="col-lg-5">
                <div class="card">
                    <div class="card-body location">
                        ...
                        <p class="card-text">
                            Hobbies Club, Indian Institute Of Technology–Roorkee
                            (IIT–Roorkee), iHUB DivyaSampark office, Roorkee, Uttarakhand
                            247667
                        </p>
                    </div>
                </div>
                <div class="card my-3">
                    <div class="card-body location">
                        ...
                        <p class="card-text">tih@iitr.ac.in</p>
                    </div>
                </div>
                <div class="card mb-2">
                    <div class="card-body location">
                        ...
                        <p class="card-text">01332-285050</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-7">
                <form action="/contactus" method="post" id="contactUSForm">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 pb-3">
                            <div class="namerow">
                                <input type="text" style="padding: 10px" class="form-control" name="name" id="name" placeholder="Your Name" />
                            </div>
                        </div>
                        <div class="col-lg-6 pb-3">
                            <div class="namerow">
                                <input type="email" name="email" id="email" style="padding: 10px" class="form-control" placeholder="Your Email" />
                            </div>
                        </div>
                        <div class="col-lg-12 pb-3">
                            <div class="namerow">
                                <input type="text" name="subject" id="subject" style="padding: 10px" class="form-control" placeholder="Subject" />
                            </div>
                        </div>
                        <div class="col-lg-12 pb-3">
                            <div class="namerow">
                                <textarea class="form-control" placeholder="Message" name="message" id="message" cols="30" rows="9"></textarea>
                                <button type="submit" class="g-recaptcha my-2" data-sitekey="6LfdbJYoAAAAAP2L96USkp-bG-FJoHeCDzPvGwUu
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-10 mx-auto">
                <form action="/feedbackmail" method="post" id="feedbackForm">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6 pb-3">
                            <div class="namerow">
                        ...
                        <div class="col-lg-12 pb-3">
                            <div class="namerow">
                                <textarea class="form-control" placeholder="Message" name="message" id="message" cols="30" rows="9"></textarea>
                                <button type="submit" class="g-recaptcha my-2" data-sitekey="6LfdbJYoAAAAAP2L96USkp-bG-FJoHeCDzPvGwUu
" data-callback='onfeedbackSubmit' data-action='submit'>SUBMIT</button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                    <div class="card board text-center">
                        <img src="https://images1.livehindustan.com/uploadimage/library/2020/10/29/16_9/16_9_1/default-image640x360.jpg" class="card-img-top" alt="Image Alt Text" />

                        <div class="card-body proff-under">
                            <a href="">Divyasampark I-Hub A Reality At IIT Roorkee </a>
                        </div>
                    </div>
                </div>
                <div class="swiper-slide">
                    <div class="card board text-center">
                        <img src="https://assets.telegraphindia.com/abped/2021/Jun/1624977659_iit-roorkee-2.jpg" class="card-img-top" alt="Image Alt Text" />
                ...
                <div class="swiper-slide">
                    <div class="card board text-center">
                        <img src="https://rnsindianews.com/wp-content/uploads/2021/08/IMG_20210802_195752.png" class="card-img-top" alt="Image Alt Text" />
