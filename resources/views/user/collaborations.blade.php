...
<div class="bgheroo mt-5 h-100">
    ...
    <div class="container">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card board text-center ">
                            <img class="toZoom" src="./public/uploads/colab/{{$slide->image}}" width="100%">
                        </div>
                    </div>
                    @endforeach
        ...
        <div class="container py-5">
            <div class="headingss py-4">
                <h2>Glimpses of activities conducted by iHub DivyaSampark</h2>
                <!-- <p>HUB GOVERNING BOARD (HGB)</p> -->
            </div>
            ...
            <div class="swiper">
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="card board text-center ">
                            <img class="toZoom" src="./public/uploads/colab/{{$activity->image}}" width="100%">
                        </div>
                    </div>
                    @endforeach
        ...
        <script>
            const swipered = new Swiper('.swiper', {
                // Optional parameters
                loop: true,
                centeredSlides: true,
                // Navigation arrows
