...
<body>
    ...
    <div class="container py-5">
        <div class="headingss py-4">
            <h2>Verticals that iHub DivyaSampark is focusing upon</h2>
    ...
    <!-- Modal -->
    @foreach($verticals as $vertical)
    <div class="modal fade" id="Modal{{$vertical->id}}" tabindex="-1" aria-labelledby="Modal{{$vertical->id}}Label" aria-hidden="true">
        <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable ">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="Modal{{$vertical->id}}Label">{{$vertical->name}}</h5>
                    <button type="button" class="btn-close closeModal" data-bs-dismiss="modal" aria-label="Close">X</button>
                </div>
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="gif">
                                <img src="./public/uploads/vertical/{{$vertical->image}}" width="100%" height="auto" alt="">
                            </div>
                        </div>
                    </div>
                </div>
