    ...
    <div class="container">
      <span class="navbar-brand mt-2" href="{{route('welcome')}}">
        ...
        <h1><a href="{{route('welcome')}}" class="logo"><img src="{{asset('/consultancy/assets/logo.png')}}" style="height: 45px; width: 55px;"></a>
          <a href="{{route('welcome')}}" class="logo mt-3" style="color: #003E74;">
            <font color="#003e74">i</font>
            <font color="#ef6603">HUB</font>
            <font color="#003e74">Divya</font>
            <font color="#ef6603">Sampark</font>
          </a>
        </h1>
            ...
            <div class="homeunderlinks ">
              <a href="#services">
                <svg width="20" height="20" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="m12.563 5.25 6.75 6.75-6.75 6.75"></path>
                  <path d="M18.375 12H4.687"></path>
                </svg> Research and Development Consultancy
              </a>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="homeunderlinks ">
              <a href="#services">
                <svg width="20" height="20" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                  <path d="m12.563 5.25 6.75 6.75-6.75 6.75"></path>
                  <path d="M18.375 12H4.687"></path>
                </svg> Project Management Consultancy (PMC)
              </a>
            </div>
          </div>
        ...
        <div class="col-lg-4 ">
          <div class="d-md-flex lastlinks">
            ...
            <a href="https://www.linkedin.com/company/divyasampark-ihub-roorkee-for-devices-materials-and-technology-foundation/mycompany/" target="_blank">
              ...
              <a href="https://www.instagram.com/divyasampark_tih_iitr?igshid=OGQ5ZDc2ODk2ZA==" target="_blank">
              <svg width="30" height="30" fill="#000000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
