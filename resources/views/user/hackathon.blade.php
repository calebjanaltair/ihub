...
<body>
    ...
    <div class="container pt-4">
        <div class="row">
            ...
            <div class="col-lg-6">
                <div class="csrimg">
                    <img src="./public/uploads/hackathon/{{$hackathon->poster}}" width="100%" alt="">
                </div>
                <div class="csrimg pt-4">
                    <a class="btn btn-primary btn-sm text-white" href="{{$hackathon->register_link}}" style="color: white !important; background-color: #003e74; text-decoration: none;" onmouseover="this.style.color='white'; this.style.backgroundColor='#003e74';" onmouseout="this.style.color='white !important'; this.style.backgroundColor='#003e74';">Register Now</a>
                </div>
                <div class="csrimg pt-4">
                    <a class="btn btn-primary btn-sm text-white" href="./public/uploads/hackathon/{{$hackathon->brochure}}" style="color: white !important; background-color: #003e74; text-decoration: none;" onmouseover="this.style.color='white'; this.style.backgroundColor='#003e74';" onmouseout="this.style.color='white !important'; this.style.backgroundColor='#003e74';">Download Brochure</a>
                </div>
            </div>
            <div class="col-lg-6">
                <div class="csr-text">
